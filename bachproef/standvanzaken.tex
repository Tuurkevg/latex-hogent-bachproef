...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{../onderzoek/ds-ceph.webp} 
  \caption{Afbeelding met ceph als toepassing van een distributed storage, afkomstig van \href{https://medium.com/@pk0752/ceph-the-next-generation-store-67f7c51780d3}{medium}.}
  \label{fig:sas}
\end{figure}
