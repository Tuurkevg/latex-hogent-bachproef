...
\begin{enumerate}
  ...
  \item Hoe kan de bestaande ondersteuning van Direct Attached Storage en Storage Area Network met SCSI in VMWare vCenter worden geintegreerd naar een alternatief managementplatformen binnen de infrastructuur van Excentis?
  \end{enumerate}
\newpage
...
\begin{itemize}
  ...
  \item Testen en meten van de performance en stabiliteit van de bestaande Direct Attached en Storage Area Network SCSI-systemen die Excentis gebruikt aan de hand van testdata op de nieuwe managementplatformen.
