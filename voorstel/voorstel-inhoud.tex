...
In het huidige systeem dat Excentis gebruikt, fungeert VMware ESXi~\autocite{vmware} als onderliggende hypervisor. Deze is closed source en werkt binnen het VMware systeem. Als atlernatief voor VMware ESXI zijn er verschillende open-source hypervisors op de markt.
